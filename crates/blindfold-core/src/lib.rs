...
//!
//! It is designed to be shared by the offline curation tool and the browser app
//! (neither written yet), so that the database and the live app cannot drift
//! apart about what "solved" means: both will call [`mate::judge`].
//!
